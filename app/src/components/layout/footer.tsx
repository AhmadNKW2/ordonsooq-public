...
const NON_INTERACTIVE_FOOTER_COLUMNS = new Set([
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                ...
                aria-label="YouTube"
              >
                <IconButton variant="social" size="default" shape="circle" icon="youtube" />
              </a>
            </div>
          </div>

          {FOOTER_COLUMNS.map((column) => {
            const isColumnInteractive = !NON_INTERACTIVE_FOOTER_COLUMNS.has(column.title);
                  ...
                  {column.links.map((link) => (
                    <li key={link.label}>
                      {isColumnInteractive ? (
                        ...
                        <span className="text-third2 cursor-default select-none">
                          {t(link.label)}
                        </span>
                      )}
                    </li>
