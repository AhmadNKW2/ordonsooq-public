        ...
        <div className={cn("relative inline-block", className)}>
          ...
          <label
            ...
            className={cn(
              ...
              "bg-white shadow-sm",
              (props.checked)
                ? "ring-2 ring-secondary text-secondary font-semibold shadow-[0_1px_2px_1px_rgba(0,0,0,0.1)]"
                : "ring-1 ring-inset ring-gray-200 hover:bg-gray-50 hover:ring-2 hover:ring-secondary/30",
              
              "peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-secondary/30 peer-focus-visible:ring-offset-2",
              "peer-checked:ring-2 peer-checked:ring-secondary peer-checked:text-secondary peer-checked:font-semibold peer-checked:shadow-[0_1px_2px_1px_rgba(0,0,0,0.1)]",
