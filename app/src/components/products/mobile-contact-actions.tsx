...
export function MobileContactActions() {
  ...
  const sanitizedPhone = useMemo(
    () => SITE_CONFIG.contact.phone.replace(/\s+/g, ""),
    []
  );
  const whatsappNumber = useMemo(
    () => SITE_CONFIG.contact.phone.replace(/\D/g, ""),
    []
  );
        ...
        {isOpen && (
          <div className="mb-3 flex flex-col items-center gap-3">
            <motion.a
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-colors hover:bg-green-600"
            ...
            <motion.a
              ...
              exit="exit"
              variants={buttonVariants}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-colors hover:bg-blue-600"
              aria-label="Call us"
            >
